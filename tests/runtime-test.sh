...
cp "$TMP/state.json" "$TMP/state-before-exit-validation.json"
"$JQ" '.nginx.mode = "disabled"' \
  "$TMP/state.json" >"$TMP/state-without-nginx-validation.json"
mv "$TMP/state-without-nginx-validation.json" "$TMP/state.json"
...
mv "$TMP/state-before-exit-validation.json" "$TMP/state.json"
